...
<form method="post" action="<?= $instance['id'] ?>/status" class="mb-4">
...
<form method="post" action="<?= $instance['id'] ?>/card" class="bg-white p-4 rounded shadow space-y-2">
<input type="hidden" name="_csrf" value="<?= e(csrf_token()) ?>">
...
<br><label>Tarjetas (una por línea)</label>
